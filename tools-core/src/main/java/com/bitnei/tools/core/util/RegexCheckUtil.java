...
public class RegexCheckUtil {
     ...
     * 带code前缀的手机号
     */
    private static final String CODE_MOBILE = "^\\+[0-9]{2}\\-(13|15|18|17|16)[0-9]{9}$";
    /**
     * 整数
     */
     ...
     * 负整数
     */
    private static final String NEGATIVE_INTEGER = "^-[1-9]\\d*$";
    /**
     * 数字
     */
    ...
    public static boolean isCodeMobile(String input) {
    ...
    public static boolean isPositiveInteger(String input) {
        return matches(POSITIVE_INTEGER, input);
    }
    ...
    public static boolean isNegativeInteger(String input) {
        return matches(NEGATIVE_INTEGER, input);
    }
