 ...
 */
package com.etiansoft.tools.filters;

import com.alibaba.fastjson.JSONObject;
import com.etiansoft.tools.aop.JsonException;
import com.etiansoft.tools.aop.Result;
...
public class JsonExceptionFilter implements Filter {
	...
	private void printJsonException(ServletResponse response, Throwable cause) throws IOException {
		String json = JSONObject.toJSONString(Result.error(cause.getMessage()));
