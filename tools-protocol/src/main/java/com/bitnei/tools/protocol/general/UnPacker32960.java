package com.bitnei.tools.protocol.general;

import com.bitnei.tools.protocol.constant.DataConst;
import com.bitnei.tools.protocol.exception.MessageException;
import com.bitnei.tools.protocol.general.bean.*;
import com.bitnei.tools.protocol.general.util.DataHandleUtil;
import com.bitnei.tools.protocol.general.util.XmlUtil;
 ...
 */
public class UnPacker32960 {

    private static List<DataUnitConfig> dataUnitConfigs = new ArrayList<>();
    ...
    public List<DataUnitConfig> getDataUnitConfigs() {
        return dataUnitConfigs;
    }

    static {
        fromClassPathXmlFile("32960.xml");
    }
     ...
     * @param xmlPath
     */
    public static UnPacker32960 fromXmlFile(final String xmlPath) {

        UnPacker32960 upacker = new UnPacker32960();
        // 获取Root节点
     ...
     * @param xmlFileName
     */
    public static UnPacker32960 fromClassPathXmlFile(final String xmlFileName) {

        UnPacker32960 upacker = new UnPacker32960();
        // 获取Root节点
        Element root = XmlUtil.getRootElement(UnPacker32960.class.getClassLoader().getResourceAsStream(xmlFileName));
        // upstream节点
        Element upstreamEl = root.getChild("upstream");
        // 获取所有的cmdTag子节点
        List<Element> cmdTagEls = upstreamEl.getChildren("cmdTag");
     ...
     * @return
     */
    public DataMessage unPack(final String message) {
